...
const SearchContainer = (props) => {
  const { pokemonOneDesc, setpokemonOneDesc, pokemonOne, setPokemonOne } =
    props;
  const dummyPokemon = {
    name: 'Darin',
    image:
      'https://www.kotaku.com.au/wp-content/uploads/sites/3/2020/04/fake-pokemon-whale.jpg?quality=80&w=1280',
    type1: 'Rock',
    type2: 'Water',
    hp: 69,
    attack: 69,
  ...
  return (
    <div className='container'>
      ...
      <div className='description'>
        <Description pokemonOneDesc={pokemonOneDesc} />
      </div>
